...
import { ExternalLink, Calendar, Tag, Send } from "lucide-react";
import Steps_of_desing_process from "../assets/Steps_of_desing_process.json";
import Lottie from "lottie-react";
import ContactModal from "@/components/ContactModal";
import ContactccModal from "../../client/assets/images/shoe_store_morroco.png";
  ...
  const projects = [
    {
      ...
      tags: ["Shopify", "Node.js", "Razorpay", "Docker", "Express", "SQL"],
      image: "",
    },
    {
      id: 2,
      title: "Marketing Templet Design",
      ...
      image: "../../client/assets/images/marketing.png",
    },
    {
      id: 3,
    ...
    },
    {
      ...
      year: "2025",
      description:
        "Create Bills, Invoices and maintain Account Book and Analytics dashboard of revenue, profit, and various stats for companies to track and optimize their sales.",
      tags: ["React", "D3.js","Node", "Analytics", "Admin.js"],
      image: "/project-4.jpg",
    },
    {
      id: 5,
    ...
    },
    {
      ...
      year: "2024",
      description:
        "A distraction-free content management system for a client who manages content and multiple writers and bloggers.",
      tags: ["Node", "React", "CMS", ""],
      image: "/project-6.jpg",
    },
  ];
      ...
      <main className="bg-cream-50 min-h-screen pt-24">
              ...
              <h1 className="font-judson text-5xl md:text-7xl lg:text-8xl text-dark-950 mb-8">
                ...
                <span className="text-orange-500 italic inline-block relative ">
                  ...
                  <svg
                    ...
                    className="text-orange-500 rotate-[-2deg]"
                    style={{
                      position: "absolute",
                      top: "1em",
                      width: "100%",
        ...
        <section className="py-20 px-4 ">
          <div className="container flex flex-col justify-center items-center">
            <h3 className="font-bricolage text-4xl font-bold text-dark-950 mb-12 text-center">
              Our Crea
            ...
            <div className="w-full rounded-2xl border border-white/20 bg-white/10  backdrop-blur-sm shadow-md p-6 md:p-8">
              ...
              <div className="flex justify-center items-center">
                <Lottie
                  className="w-[100%]"
                  animationData={Steps_of_desing_process}
                  loop
                  autoplay
                />
              </div>
