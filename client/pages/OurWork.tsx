  ...
  const projects = [
    {
      ...
      category: "E-commerce",
      year: "2024",
      description: "A sustainable e-commerce platform focusing on eco-friendly products with minimal environmental impact.",
    ...
    },
    {
      ...
      year: "2023",
      description: "A meditation and mindfulness app designed with privacy-first principles and calming aesthetics.",
    ...
    },
    {
      ...
      year: "2023",
      description: "Digital platform connecting local artists with art enthusiasts in their community.",
    ...
    },
    {
      ...
      year: "2024",
      description: "Analytics dashboard for renewable energy companies to track and optimize their green initiatives.",
    ...
    },
    {
      ...
      category: "Education",
      year: "2023",
      description: "Collaborative learning platform that helps students connect and study together effectively.",
    ...
    },
    {
      ...
      year: "2024",
      description: "A distraction-free content management system for writers and bloggers who value simplicity.",
      tags: ["Svelte", "Markdown", "CMS", "Writing"],
      image: "/project-6.jpg"
    }
  ];

  const categories = ["All", "E-commerce", "Health & Wellness", "Art & Culture", "Sustainability", "Education", "Content Management"];
          ...
          <div className="container mx-auto">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="font-bricolage text-xl text-dark-950 leading-relaxed max-w-3xl mx-auto">
                A curated collection of projects that showcase our commitment to creating 
                beautiful, functional, and privacy-respecting digital experiences.
              </p>
            </div>
          </div>
        </section>
  ...
  <div className="group bg-white/20 backdrop-blur-sm rounded-2xl overflow-hidden border border-cream-300/30 hover:shadow-xl transition-all duration-300">
    ...
    <div className="p-6">
      <div className="flex items-center gap-4 mb-3">
        <span className="text-orange-500 font-bricolage text-sm font-medium">{project.category}</span>
        <div className="flex items-center gap-1 text-dark-950/60">
          <Calendar className="w-4 h-4" />
          <span className="font-bricolage text-sm">{project.year}</span>
        </div>
      </div>
      <h3 className="font-bricolage text-xl font-bold text-dark-950 mb-3">{project.title}</h3>
      <p className="font-bricolage text-sm text-dark-950 leading-relaxed mb-4">{project.description}</p>
