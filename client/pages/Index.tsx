          ...
          <div className="container mx-auto text-center relative z-10">
            ...
            <div className="mb-8">
              <h1 className="font-judson text-6xl md:text-8xl lg:text-9xl leading-none">
                ...
                <span className="text-orange-500 italic inline-block relative">which helps<svg
                    width="240"
                    height="11"
                    viewBox="0 0 240 11"
                    fill="currentColor"
            ...
            <div className="mb-12 space-y-2">
              ...
              <p className="font-bricolage text-[28px] text-muted-foreground max-w-md mx-auto !mt-[0]">
                Think Smart.{" "}
              </p>
            </div>
