  ...
  const faqs = [
    {
      ...
      answer:
        "Project timelines vary based on scope and complexity. Simple websites typically take 4-6 weeks, while complex applications can take 3-6 months. We'll provide a detailed timeline during our initial consultation.",
    },
    {
      question: "What is your pricing structure?",
      answer:
        "Our pricing is project-based and depends on your specific requirements. We offer transparent pricing with no hidden fees. Contact us for a detailed quote tailored to your needs.",
    },
    {
      question: "Do you provide ongoing support?",
      answer:
        "Yes! We offer various maintenance and support packages to ensure your project continues to perform optimally after launch. This includes updates, security monitoring, and technical support.",
    },
    {
      question: "Can you work with our existing team?",
      answer:
        "Absolutely! We love collaborating with in-house teams and can integrate seamlessly into your existing workflow. We're flexible and adapt to your preferred communication and project management tools.",
    },
  ];
          ...
          <div className="container mx-auto">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="font-bricolage text-xl text-dark-950 leading-relaxed max-w-3xl mx-auto mb-8">
                Ready to bring your digital vision to life? We'd love to hear
                about your project and explore how we can help you create
