          ...
          <div className="container mx-auto">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="font-bricolage text-xl text-dark-950 leading-relaxed max-w-3xl mx-auto">
                We are a passionate team of designers and developers who believe in creating 
                digital experiences that prioritize user privacy, beautiful design, and 
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="font-bricolage text-lg text-dark-950 leading-relaxed mb-6">
                  To create a calmer, more thoughtful internet where technology serves 
                  humanity without compromising privacy or overwhelming users with unnecessary distractions.
                </p>
                <p className="font-bricolage text-lg text-dark-950 leading-relaxed">
                  We believe that digital solutions should enhance productivity and creativity 
                  while respecting user data and promoting mindful interaction with technology.
                </p>
              </div>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-6 text-lg text-dark-950 leading-relaxed">
                <p className="font-bricolage">
                  Dumb Potato was born from a simple observation: the internet had become too noisy, 
                  too intrusive, and too complicated. We started with a vision to create digital 
                  experiences that would be calmer, more respectful, and more focused on what truly matters.
                </p>
                <p className="font-bricolage">
                  Our name, "Dumb Potato," reflects our philosophy of simplicity. Like a potato, 
                  we believe in being grounded, reliable, and nourishing. The "dumb" part reminds 
                  us to keep things simple and not overthink solutions that should be elegant and straightforward.
                </p>
                <p className="font-bricolage">
                  Since our founding, we've worked with companies of all sizes, from startups to 
                  established enterprises, helping them create digital products that their users 
...
const TeamMember = ({ name, role, description }: { 
  ...
  <div className="text-center">
    ...
    <h3 className="font-bricolage text-xl font-bold text-dark-950 mb-2">{name}</h3>
