          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                {errors.name && (
                  <p className="mt-1 text-sm text-red-500 font-bricolage">{errors.name}</p>
                )}
              </div>
              ...
              <div>
                ...
                {errors.email && (
                  <p className="mt-1 text-sm text-red-500 font-bricolage">{errors.email}</p>
                )}
              </div>
              ...
              <div>
                ...
                {errors.message && (
                  <p className="mt-1 text-sm text-red-500 font-bricolage">{errors.message}</p>
                )}
              </div>
